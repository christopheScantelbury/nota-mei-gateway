...
const PLANS: Plan[] = [
  {
    ...
    desc: 'Para experimentar a plataforma sem cadastrar cartão.',
    extra: null,
    cta: 'Começar grátis',
    highlight: false,
  },
  {
    ...
    desc: 'Para quem emite muito raramente.',
  ...
  },
  {
    ...
    period: '/mês',
    limit: '15 notas/mês',
    desc: 'Para MEI com fluxo regular de clientes.',
  ...
  },
  {
    ...
    period: '/mês',
    limit: '100 notas/mês',
    desc: 'Para MEI com alto volume de emissões.',
    extra: 'R$ 0,30 por nota acima do limite',
    cta: 'Assinar agora',
    highlight: false,
  },
]

export default function PricingToggleMei({ plans }: { plans?: Plan[] }) {
